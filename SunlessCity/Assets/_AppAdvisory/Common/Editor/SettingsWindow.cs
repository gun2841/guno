...
namespace AppAdvisory
{
	public class SettingsWindow : EditorWindow
	{
        ...
        adIDs.EnableFacebook = value;
                ...
                ScriptingSymbolsManager.SetAudienceNetworkSymbol (value);
        }
        }
		...
		void DisplayGIFSettings()
		{
			...
			if (gifSettings.isGIFFoldoutOpened)
			{
                ...
                EditorWindowUtils.CreateTextField(ref gifSettings.giphyKey, "Giphy Key", "Get the giphy key on https://github.com/Giphy/GiphyAPI", margin);
                EditorWindowUtils.CreateTextField(ref gifSettings.username, "Giphy username", "Put your Giphy usernam here", margin);

				EditorWindowUtils.CreateIntSlider(ref gifSettings.m_width, 8, 2048, "Width", 400, margin);

				//EditorWindowUtils.CreateIntSlider(ref gifSettings.m_height, 8, 2048, "Height", 400, margin);
                ...
                EditorWindowUtils.CreateIntSlider(ref gifSettings.m_FramesPerColorSample, 0, 6, "Frames Per Color Sample", 400, margin);
				...
				EditorGUILayout.BeginHorizontal();
				GUILayout.Space(margin);
				gifSettings.watermark = (Texture2D)EditorGUILayout.ObjectField("Watermark", gifSettings.watermark, typeof(Texture2D), false);
				EditorGUILayout.EndHorizontal();
